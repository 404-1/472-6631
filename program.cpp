...
#include "image_transfer.h" // include this header file for computer vision functions
...
/* //calling the defense mode function to update movement logic
    defenseMode(myPosition, opponentPosition, obstacles, obstacleRadius, pw_l, pw_r);

    //output the movement decision for debugging
    cout << "Wheel powers after defenseMode: pw_l = " << pw_l << ", pw_r = " << pw_r << "\n";
*/
